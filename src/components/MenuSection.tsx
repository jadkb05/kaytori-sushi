          ...
          <header className="mx-auto mb-12 max-w-2xl text-center md:mb-16">
            ...
            <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
              <a
                ...
                className="btn-shine inline-flex items-center justify-center gap-2 rounded-2xl bg-gold-shine px-9 py-4 text-sm font-semibold text-kaytori-black shadow-[0_12px_40px_rgba(212,175,55,0.38)] transition-all duration-300 ease-smooth hover:-translate-y-1 hover:shadow-gold"
              >
                Ouvrir en plein écran
              </a>
              <a
                href={SITE.menuPdfUrl}
                download="Menu-Kaytori.pdf"
                className="inline-flex items-center justify-center rounded-2xl border-2 border-kaytori-black/[0.88] bg-white/90 px-9 py-4 text-sm font-semibold text-kaytori-black shadow-card backdrop-blur-sm transition-all duration-300 ease-smooth hover:border-kaytori-gold hover:bg-white"
              >
                Télécharger le PDF
              </a>
            </div>
              ...
              <div className="overflow-hidden rounded-[25px] bg-[#0d1210] ring-1 ring-white/10">
                ...
                <div className="border-t border-white/[0.07] bg-gradient-to-r from-transparent via-white/[0.03] to-transparent px-5 py-3 text-center sm:px-8">
                  <p className="text-[0.78rem] leading-relaxed text-white/52">
                    ...
                    <strong className="font-semibold text-kaytori-goldLight/90">
                      Ouvrir en plein écran
                    </strong>{" "}
